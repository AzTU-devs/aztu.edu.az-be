...
DOMAIN_LABELS: Dict[str, Tuple[str, str]] = {
    ...
    "about": ("Haqqımızda səhifələri", "About pages"),
...
PERMISSION_CATALOGUE: Tuple[PermissionDef, ...] = (
    ...
    # ── about ───────────────────────────────────────────────────────────────
    _p("about.create", "Haqqımızda səhifəsi yaratmaq", "Create about page"),
    _p("about.update", "Haqqımızda səhifəsini redaktə etmək", "Edit about page"),
    _p("about.delete", "Haqqımızda səhifəsini silmək", "Delete about page"),
    _p("about.activate", "Haqqımızda səhifəsini dərc etmək", "Publish about page"),
    _p("about.upload_image", "Səhifə şəklini yükləmək", "Upload about page image"),
    _p("about.upload_file", "Səhifəyə sənəd yükləmək", "Upload about page document"),
    _p("about.section.create", "Bölmə əlavə etmək", "Add about section"),
    _p("about.section.update", "Bölməni redaktə etmək", "Edit about section"),
    _p("about.section.delete", "Bölməni silmək", "Delete about section"),
    _p("about.section.reorder", "Bölmələri sıralamaq", "Reorder about sections"),
    _p("about.item.create", "Bölmə elementi əlavə etmək", "Add about item"),
    _p("about.item.update", "Bölmə elementini redaktə etmək", "Edit about item"),
    _p("about.item.delete", "Bölmə elementini silmək", "Delete about item"),
    _p("about.item.reorder", "Bölmə elementlərini sıralamaq", "Reorder about items"),
    _p("about.item.upload_image", "Element şəklini yükləmək", "Upload about item image"),
    _p("about.item.upload_file", "Elementə sənəd yükləmək", "Upload about item document"),
    _p("about.person.create", "Şəxs əlavə etmək", "Add about person"),
    _p("about.person.update", "Şəxsi redaktə etmək", "Edit about person"),
    _p("about.person.delete", "Şəxsi silmək", "Delete about person"),
    _p("about.person.reorder", "Şəxsləri sıralamaq", "Reorder about people"),
    _p("about.person.upload_image", "Şəxsin şəklini yükləmək", "Upload about person image"),
    # ── menu ────────────────────────────────────────────────────────────────
...
SYSTEM_ROLES: Tuple[SystemRoleDef, ...] = (
    ...
    SystemRoleDef(
        ...
        description_az="Xəbər, elan, hero, layihə, əməkdaşlıq və Haqqımızda səhifələrini idarə edir. Silmək icazəsi yoxdur.",
        permissions=_without(
            keys_for_domains(
                "news", "news_categories", "announcements", "hero", "projects",
